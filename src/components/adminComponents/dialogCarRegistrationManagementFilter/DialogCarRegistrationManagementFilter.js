...
import {
    ...
    TextStyle,
    Title,
} from "./DialogCarRegistrationManagementFilterCustomStyles";
...
function DialogCarRegistrationManagementFilter({
    open,
    handleClose,
    onSubmit = () => {},
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                {/* TITLE */}
                <Title>
                    {Strings.DialogCarRegistrationManagementFilter.TITLE}
                </Title>
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.DRIVER}
                    </TextStyle>
                    <TextInput
                        placeholder={
                            Strings.DialogCarRegistrationManagementFilter
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.FACULTY}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.STATUS}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.CAR_TYPE}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.TIME}{" "}
                    </TextStyle>
                    <DatePicker
                        locale="vi"
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogCarRegistrationManagementFilter.ADDRESS}{" "}
                    </TextStyle>
                    <ButtonStyled
            ...
            <ModalShowAddress
                ...
                labelInput={
                    Strings.DialogCarRegistrationManagementFilter.ENTER_LOCATION
                }
...
export default DialogCarRegistrationManagementFilter;
