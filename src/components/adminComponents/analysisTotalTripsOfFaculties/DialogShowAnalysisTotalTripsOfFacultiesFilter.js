...
import {
    ...
    TextStyle,
    Title,
} from "./DialogShowAnalysisTotalTripsOfFacultiesFilterCustomStyles";
...
function DialogShowAnalysisTotalTripsOfFacultiesFilter({
    open,
    handleClose,
    onSubmit = () => {},
        ...
        return (
            <Tooltip
                title={
                    value
                        ? value
                        : Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.CHOOSE_TIME
                }
            >
                <Box
                    sx={{
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                {/* TITLE */}
                <Title>
                    {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.TITLE}
                </Title>
                ...
                <BoxContent>
                    ...
                    >
                        <FormControlLabel
                            ...
                            control={<Radio />}
                            label={
                                Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.YES
                            }
                        />
                        <FormControlLabel
                            value={false}
                            control={<Radio />}
                            label={
                                Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.NO
                            }
                        />
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.SUBSCRIBERS}
                    </TextStyle>
                    <TextInput
                        placeholder={
                            Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.DRIVER}
                    </TextStyle>
                    <TextInput
                        placeholder={
                            Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.FACULTY}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.STATUS}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.CAR_TYPE}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.TIME}{" "}
                    </TextStyle>
                    <DatePicker
                        locale="vi"
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.ADDRESS}{" "}
                    </TextStyle>
                    <ButtonStyled
            ...
            <ModalShowAddress
                ...
                labelInput={
                    Strings.DialogShowAnalysisTotalTripsOfFacultiesFilter.ENTER_LOCATION
                }
...
export default DialogShowAnalysisTotalTripsOfFacultiesFilter;
