...
import {
    ...
    Title,
    FabStyle,
} from "./DialogShowAnalysisTotalTripsOfFacultiesCustomStyles";
...
import col from "./columnsDialogShowAnalysisTotalTripsOfFacultiesDataGrid";
...
import DialogShowAnalysisTotalTripsOfFacultiesFilter from "./DialogShowAnalysisTotalTripsOfFacultiesFilter";
...
function DialogShowAnalysisTotalTripsOfFaculties({
    ...
    const getDataAnalysisTotalTripsOfFaculties = async (
        page = dataInfo.page,
        ...
        const res =
            await AnalysisTotalTripsOfFacultiesServices.getDataAnalysisTotalTripsOfFaculties(
                {
                    ...data,
                }
            );
    ...
    const getDataAnalysisTotalTripsOfFacultiesToExport = async () => {
    ...
    const handleChangePage = async (e) => {
        ...
        const data = await handleFormatDataFilterSendApi(dataFilter);
        await getDataAnalysisTotalTripsOfFaculties(
            e,
            dataInfo.pageSize,
            data.haveSchedule,
            data.status,
    ...
    const exportExcel = async () => {
        let getData = await getDataAnalysisTotalTripsOfFacultiesToExport();

        if (getData) {
            // FORMAT NAME FILE EXPORT
            let nameFile = "Danh_Sach_Lich_Trinh_Cua_Cac_Khoa.xlsx";
            if (getData.date.startDate && getData.date.endDate) {
                ...
                nameFile = `Danh_Sach_Lich_Trinh_Cua_Cac_Khoa_Tu_${startDate}_Den_${endDate}.xlsx`;
            }
            let dataExport = [
        ...
        >
            <DialogContent>
                <Box>
                    {/* TITLE */}
                    <Title>
                        {Strings.DialogShowAnalysisTotalTripsOfFaculties.TITLE}
                        {title}
                    </Title>
