...
import {
    ...
    TextStyle,
    Title,
} from "./DialogRentedCarFilterCustomStyles";
...
function DialogRentedCarFilter({
    open,
    handleClose,
    onSubmit = () => {},
        ...
        return (
            <Tooltip
                title={
                    value
                        ? value
                        : Strings.DialogRentedCarFilter.CHOOSE_TIME
                }
            >
                <Box
                    sx={{
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                {/* TITLE */}
                <Title>{Strings.DialogRentedCarFilter.TITLE}</Title>

                {/* SCHEDULE CODE */}
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogRentedCarFilter.SCHEDULE_CODE}
                    </TextStyle>
                    <TextInput
                        placeholder={
                            Strings.DialogRentedCarFilter
                                .ENTER_SCHEDULE_CODE
                        }
                        variant="outlined"
                        size="small"
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogRentedCarFilter.STATUS}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogRentedCarFilter.CAR_TYPE}
                    </TextStyle>
                    <AutocompleteStyle
                        disablePortal={false}
                        multiple
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogRentedCarFilter.TIME}{" "}
                    </TextStyle>
                    <DatePicker
                        locale="vi"
                ...
                <BoxContent>
                    <TextStyle>
                        {Strings.DialogRentedCarFilter.ADDRESS}{" "}
                    </TextStyle>
                    <ButtonStyled
            ...
            <ModalShowAddress
                ...
                labelInput={
                    Strings.DialogRentedCarFilter.ENTER_LOCATION
                }
...
export default DialogRentedCarFilter;
